            ...
            <table class="table table-striped table-bordered">
              ...
              <tr v-for='component in components'>
                ...
                <td style="text-align:center" width='15%'>
                  <button v-on:click="destroy(component.id)" class="btn btn-sm btn-danger">Delete</button>
                </td>
              </tr>
            </table>
          </div>
            ...
            <div class="modal-body">
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div v-if="selected_type === 'text' || selected_type === 'number' || selected_type === 'textarea'">
                  ...
                  <div v-if="selected_type === 'textarea'">
                    <div class="form-group">
                      <label for="readonly">Rows:</label>
                      <input v-model="inputComponent.rows" autocomplete="off" type="number" class="form-control">
                    </div>
                  </div>
